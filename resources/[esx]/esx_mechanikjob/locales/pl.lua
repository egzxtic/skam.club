Locales['pl'] = {
  ...
  ['armory_bought'] = 'Kupiono %s za $%s',
  ['armory_money'] = 'frakcja nie posiada wystarczająco pieniędzy',
  ...
  ['garage_prompt'] = 'naciśnij [E], aby otworzyć garaż policyjny',
  ...
  ['helicopter_prompt'] = 'naciśnij [E], aby otworzyć garaż helikopterów',
  ['shop_item'] = '$%s',
  ...
  ['being_searched'] = 'jesteś przeszukiwany przez policjanta',
  -- Vehicle interaction
  ...
  ['search_database_error_invalid'] = 'to nie jest poprawny numer rejestracyjny',
  -- Traffic interaction
  ...
  ['confiscate_weapon'] = 'skonfiskuj %s z %s pociskami',
  ...
  ['got_confiscated_weapon'] = 'twój %s z ~o~%s pociskami został skonfiskowany przez %s',
  ...
  -- Notifications
  ['alert_mechanik'] = 'ostrzeż policję',
  ['phone_mechanik'] = 'mechanik',
}