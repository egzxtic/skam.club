...
CreateThread(function()
    while true do
        ...
        if isCameraActive then
            ...
            exports['skam-ui']:helpNotify({ desc = 'Użyj A oraz D aby obracać kamerą.\nUżyj W oraz S aby oddalić/przybliżyć kamerę.'})
        end
        Wait(sleep)
    end
end)
...
function OpenSaveableMenu(submitCb, cancelCb, restrict)
    ...
    OpenMenu(function(data, menu)
        ...
        TriggerEvent('skinchanger:getSkin', function(skin)
            ...
            if type(submitCb) == "function" then
                submitCb(data, menu)
            end
        end)
        exports['skam-ui']:hideHelpNotify()
...
AddEventHandler('esx_skin:playerRegistered', function()
    CreateThread(function()
        ...
        if firstSpawn then
            TriggerServerEvent('esx_skin:getPlayerSkin', function(skin, jobSkin)
                if skin == nil then
