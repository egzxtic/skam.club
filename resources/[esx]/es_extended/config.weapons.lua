...
Config.Weapons = {
	{
        name = 'WEAPON_GLOCK20',
        label = ('custom-glock20'),
		item = "custom-glock20",
		ammo = {label = _U('ammo_rounds'), hash = `AMMO_PISTOL`},
        components = {
            { name = 'clip_default', label = _U('component_clip_default'), hash = GetHashKey('glock20_clip_01') },
			{ name = 'clip_extended', label = _U('component_clip_extended'), hash = GetHashKey('glock20_clip_02') },
			{ name = 'flashlight', label = _U('component_flashlight'), hash = GetHashKey(`glock20_flsh_01`)},
        }
    },
	{
        name = 'WEAPON_M9',
        ...
        components = {
			...
			{ name = 'suppressor', label = _U('component_suppressor'), hash = GetHashKey('w_at_m9_supp') },
			{ name = 'flashlight', label = _U('component_flashlight'), hash = GetHashKey(`w_at_m9_flsh`)},
        }
    },
	{
        name = 'WEAPON_B92FS',
	...
	{
        name = 'WEAPON_SWPOLICE',
        label = ('custom-sw'),
		item = "custom-sw",
		ammo = {label = _U('ammo_rounds'), hash = `AMMO_PISTOL`},
        components = {
            { name = 'clip_default', label = _U('component_clip_default'), hash = GetHashKey('w_pi_swpolice_mag1') },
			{ name = 'suppressor', label = _U('component_suppressor'), hash = GetHashKey('w_at_pi_supp') },
        }
    },

	-- Melee
	{name = 'WEAPON_DAGGER', label = _U('weapon_dagger'), components = {}},
	{name = 'WEAPON_BAT', label = _U('weapon_bat'), item = 'bat', components = {}},
	...
	{name = 'WEAPON_CROWBAR', label = _U('weapon_crowbar'), item = 'crowbar', components = {}},
	...
	{name = 'WEAPON_KNIFE', label = _U('weapon_knife'), item = 'knife', components = {}},
	{name = 'WEAPON_MACHETE', label = _U('weapon_machete'), item = 'machete', components = {}},
	{name = 'WEAPON_NIGHTSTICK', label = _U('weapon_nightstick'), item = 'nightstick', components = {}},
