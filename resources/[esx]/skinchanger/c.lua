local Components = {
    {label = "Płeć",                      name = 'sex',             value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65},
    {label = "Twarz 1",                   name = 'face',            value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65},
    {label = "Twarz 2",                   name = 'face_2',          value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65},
    {label = "Miks twarzy 2 z 1",         name = 'blend_face',      value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65},
    {label = "Skóra 1",                   name = 'skin',            value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65},
    {label = "Skóra 2",                   name = 'skin_2',          value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65},
    {label = "Miks skóry 2 z 1",          name = 'blend_skin',      value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65},
    {label = "Twarz 3",                   name = 'face_3',          value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65},
    {label = "Skóra 3",                   name = 'skin_3',          value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65},
    {label = "Miks skóry 3 i twarzy 3 nad pozostałe", name = 'blend', value = 0, min = 0,  zoomOffset = 0.6,    camOffset = 0.65},
    {label = "Włosy 1",                   name = 'hair_1',          value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65},
    {label = "Włosy 2",                   name = 'hair_2',          value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65},
    {label = "Pokrycie głowy",            name = 'hair_3',          value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65},
    {label = "Kolor włosów 1",            name = 'hair_color_1',    value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65},
    {label = "Kolor włosów 2",            name = 'hair_color_2',    value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65},
    {label = "T-Shirt",                   name = 'tshirt_1',        value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15, restrictMale = {197, 198}, restrictFemale = {267, 271}},
    {label = "Wariant T-Shirtu",          name = 'tshirt_2',        value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15, textureof = 'tshirt_1'},
    {label = "Tułów",                     name = 'torso_1',         value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15, restrictMale = {458, 461, 499}, restrictFemale = {507, 524}},
    {label = "Wariant tułowia",           name = 'torso_2',         value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15, textureof = 'torso_1'},
    {label = "Dodatki",                   name = 'decals_1',        value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15},
    {label = "Wariant dodatków",          name = 'decals_2',        value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15, textureof = 'decals_1'},
    {label = "Ramiona",                   name = 'arms',            value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15},
    {label = "Wariant ramion",            name = 'arms_2',          value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15, textureof = 'arms'},
    {label = "Spodnie",                   name = 'pants_1',         value = 0,   min = 0,   zoomOffset = 0.8,    camOffset = -0.5},
    {label = "Wariant spodni",            name = 'pants_2',         value = 0,   min = 0,   zoomOffset = 0.8,    camOffset = -0.5, textureof = 'pants_1'},
    {label = "Buty",                      name = 'shoes_1',         value = 0,   min = 0,   zoomOffset = 0.8,    camOffset = -0.8},
    {label = "Wariant butów",             name = 'shoes_2',         value = 0,   min = 0,   zoomOffset = 0.8,    camOffset = -0.8, textureof = 'shoes_1'},
    {label = "Maska",                     name = 'mask_1',          value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65, restrictMale = {211, 212, 213}, restrictFemale = {204, 205}},
    {label = "Wariant maski",             name = 'mask_2',          value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65, textureof = 'mask_1'},
    {label = "Kamizelka kuloodporna",     name = 'bproof_1',        value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15},
    {label = "Typ kamizelki kuloodpornej",name = 'bproof_2',        value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15, textureof = 'bproof_1'},
    {label = "Łańcuch",                   name = 'chain_1',         value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65},
    {label = "Wariant łańcucha",          name = 'chain_2',         value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65, textureof = 'chain_1'},
    {label = "Czapka",                    name = 'helmet_1',        value = -1,  min = -1,  zoomOffset = 0.6,    camOffset = 0.65, componentId = 0},
    {label = "Wariant czapki",            name = 'helmet_2',        value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65, textureof = 'helmet_1'},
    {label = "Okulary",                   name = 'glasses_1',       value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65},
    {label = "Wariant okularów",          name = 'glasses_2',       value = 0,   min = 0,   zoomOffset = 0.6,    camOffset = 0.65, textureof = 'glasses_1'},
    {label = "Dodatek lewej ręki",        name = 'watches_1',       value = -1,  min = -1,  zoomOffset = 0.75,   camOffset = 0.15},
    {label = "Wariant dodatku lewej ręki",name = 'watches_2',       value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15, textureof = 'watches_1'},
    {label = "Dodatek prawej ręki",       name = 'bracelets_1',     value = -1,  min = -1,  zoomOffset = 0.75,   camOffset = 0.15},
    {label = "Wariant dodatku prawej ręki",name = 'bracelets_2',    value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15, textureof = 'bracelets_1'},
    {label = "Plecak",                    name = 'bags_1',          value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15},
    {label = "Typ plecaka",               name = 'bags_2',          value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15, textureof = 'bags_1'},
    {label = "Kolor oczu",                name = 'eye_color',       value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Intensywność brwi",         name = 'eyebrows_2',      value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Rodzaj brwi",               name = 'eyebrows_1',      value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Kolor brwi 1",              name = 'eyebrows_3',      value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Kolor brwi 2",              name = 'eyebrows_4',      value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Rodzaj makijażu",           name = 'makeup_1',        value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Grubość makijażu",          name = 'makeup_2',        value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Kolor makijażu 1",          name = 'makeup_3',        value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Kolor makijażu 2",          name = 'makeup_4',        value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Rodzaj szminki",            name = 'lipstick_1',      value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Intensywność szminki",      name = 'lipstick_2',      value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Kolor szminki 1",           name = 'lipstick_3',      value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Kolor szminki 2",           name = 'lipstick_4',      value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Akcesoria na uszy",         name = 'ears_1',          value = -1,  min = -1,  zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Wariant akcesorii na uszy", name = 'ears_2',          value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65, textureof = 'ears_1'},
    {label = "Włosy na ciele",            name = 'chest_1',         value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15},
    {label = "Intensywność włosów na ciele", name = 'chest_2',      value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15},
    {label = "Kolor włosów na ciele",     name = 'chest_3',         value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15},
    {label = "Pieprzyki na ciele",        name = 'bodyb_1',         value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15},
    {label = "Intensywność pieprzyków na ciele", name = 'bodyb_2',  value = 0,   min = 0,   zoomOffset = 0.75,   camOffset = 0.15},
    {label = "Zmarszczki",                name = 'age_1',           value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Intensywność zmarszczek",   name = 'age_2',           value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Skazy twarzy",              name = 'blemishes_1',     value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Intensywność skaz twarzy",  name = 'blemishes_2',     value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Pudrowanie",                name = 'blush_1',         value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Intensywność pudrowania",   name = 'blush_2',         value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Kolor pudrowania",          name = 'blush_3',         value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Rumieńce",                  name = 'complexion_1',    value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Intensywność rumieńców",    name = 'complexion_2',    value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Cera",                      name = 'sun_1',           value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Intensywność cery",         name = 'sun_2',           value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Piegi",                     name = 'moles_1',         value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Intensywność piegów",       name = 'moles_2',         value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Typ brody",                 name = 'beard_1',         value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Intensywność brody",        name = 'beard_2',         value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Kolor brody 1",             name = 'beard_3',         value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Kolor brody 2",             name = 'beard_4',         value = 0,   min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Szerokość nosa",            name = 'nose_1',          value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Wysokość nosa",             name = 'nose_2',          value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Wielkość nosa",             name = 'nose_3',          value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Kość nosowa",               name = 'nose_4',          value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Zadartość nosa",            name = 'nose_5',          value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Krzywizna nosa",            name = 'nose_6',          value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Wysokość brwi",             name = 'eyebrow_1',       value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Wypukłość brwi",            name = 'eyebrow_2',       value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Wysokość kości policzkowa", name = 'cheeks_1',        value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Wypukłość kości policzkowej", name = 'cheeks_2',      value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Przesunięcie kości policzkowej", name = 'cheeks_3',   value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Wielkość ust",              name = 'lips',            value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Kształt szczęki",           name = 'jaw_1',           value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Szerokość szczęki",         name = 'jaw_2',           value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Szerokość żuchwy",          name = 'chimp_1',         value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Wysokość żuchwy",           name = 'chimp_2',         value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Wysunięcie żuchwy",         name = 'chimp_3',         value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Kształt brody",             name = 'chimp_4',         value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65},
    {label = "Wcięcie brody",             name = 'neck',            value = 10,  min = 0,   zoomOffset = 0.4,    camOffset = 0.65}
}
